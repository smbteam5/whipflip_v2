                        ...
                        <div class="card-body">
                          <form autocomplete="off" class="form" role="form">
                            ...
                            <div class="form-group row">
                              <div class="col-lg-12">
                                <input
                                  class="btn btn-secondary getOfferBtn"
                                  type="reset"
        ...
        <div className="container">
          <div className="secHd text-center">
            ...
            <h2 className="mob-show">
              <span>
                <span>Hooray! </span> <span>Selling Your Car</span> is Now 100%
              </span>
      ...
      <div className="happy-customers pt100 pb100">
        <div className="secHd text-center">
          ...
          <span>
            ...
            <span>
              <img src="/images/google.svg" alt="Goole" title="Google" />
            </span>{" "}
            certified reviews
          </span>
          <h2 className="desk-show">
            ...
            <div className="col-lg-10 colsciLeft">
              <div className="sciLeft">
                ...
                <p>
                  ...
                  a few cars ourselves and went though the same struggles you
                ...
                <p>
                  ...
                  believe we have created it and it’s here at your fingertips.Go
                  ahead and give us a try!{" "}
                </p>
                <p>
                  We welcome you join the thousands of other customers who
